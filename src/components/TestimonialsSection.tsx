...
const fallback: Testimonial[] = [
  ...
  { name: "Sarah Mitchell", role: "CEO, GrowthLoop Agency", avatar_url: sarahImg, platform: "LinkedIn", rating: 5, text: "We had massive data discrepancies between GA4 and our ad platforms. Abdullah implemented server-side tracking with Meta CAPI and our conversion accuracy jumped by over 30%." },
  { name: "David Chen", role: "E-Commerce Manager, NovaBrand", avatar_url: davidImg, platform: "Upwork", rating: 5, text: "Professional, fast, and extremely knowledgeable. The GTM setup and enhanced conversions implementation were done flawlessly. Our attribution data finally makes sense." },
  { name: "Emily Rodriguez", role: "Head of Growth, SaaSMetrics", avatar_url: emilyImg, platform: "Direct Client", rating: 5, text: "Abdullah built our entire tracking infrastructure from scratch — GA4, GTM, and CRM integration. We can now track every touchpoint in our trial-to-paid funnel." },
  { name: "Michael Brooks", role: "PPC Specialist, AdScale Co.", avatar_url: michaelImg, platform: "Fiverr", rating: 5, text: "After the server-side tracking setup, our Facebook ad campaigns started optimizing correctly again. iOS14 data loss is no longer an issue. Highly recommend." },
  { name: "Olivia Tran", role: "Founder, LeadHarvest", avatar_url: oliviaImg, platform: "Upwork", rating: 5, text: "We were sending duplicate form submissions to Google Ads. Abdullah cleaned up our GTM container, added deduplication, and our cost per lead dropped by 35%." },
];
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
          {testimonials.map((t, i) => (
            ...
            >
              ...
              {/* Text — clamped */}
              <p className="text-sm text-muted-foreground leading-relaxed flex-1 line-clamp-5">"{t.text}"</p>
            </motion.div>
          ))}
        </div>
      </div>
