...
const cases = [
  {
    ...
    metrics: [
      { label: "Conversion Accuracy", value: "+32%" },
      { label: "ROAS Improvement", value: "+18%" },
    ],
    chartData: [{ v: 30 }, { v: 25 }, { v: 35 }, { v: 50 }, { v: 48 }, { v: 65 }, { v: 72 }, { v: 80 }],
  },
  {
    title: "SaaS Platform",
    ...
    metrics: [
      { label: "Attribution Coverage", value: "100%" },
      { label: "CAC Reduction", value: "-24%" },
    ],
    chartData: [{ v: 15 }, { v: 20 }, { v: 18 }, { v: 30 }, { v: 42 }, { v: 55 }, { v: 60 }, { v: 78 }],
  },
  {
    ...
    metrics: [
      { label: "Data Accuracy", value: "+68%" },
      { label: "Cost Per Lead", value: "-35%" },
    ],
    chartData: [{ v: 40 }, { v: 35 }, { v: 45 }, { v: 38 }, { v: 55 }, { v: 62 }, { v: 70 }, { v: 85 }],
  },
];
